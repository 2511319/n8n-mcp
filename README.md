...
[![smithery badge](https://smithery.ai/badge/@2511319/n8n-mcp)](https://smithery.ai/server/@2511319/n8n-mcp)
...
To install n8n-mcp for Claude Desktop automatically via [Smithery](https://smithery.ai/server/@2511319/n8n-mcp):

```bash
npx -y @smithery/cli install @2511319/n8n-mcp --client claude
```
